...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"derivation_path_ltc_native_desc", "Native SegWit compatible, starts with \"ltc.\""},
    {"derivation_path_ltc_nested_desc", "Nested SegWit compatible, starts with \"M.\""},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"nufi_connection_notice_desc", "Подключение через QR-код NuFi Wallet сейчас недоступно. Пожалуйста, подключитесь через USB."},
